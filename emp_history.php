        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                    if(isset($_GET['empid'])){
                        $staff_id = $_GET['empid']; // Note: URL parameter name is 'empid', but column is now 'staff_id'
                    }else{
                        header('Location:404.php');
                    }
                    $emp = "SELECT * FROM staff WHERE staff_id='$staff_id'";
                    $emp_result = mysqli_query($connection,$emp);
                    $employee = mysqli_fetch_assoc($emp_result);
                    ?>
                    <p><b>Employee Name: </b> <?php echo $employee['staff_name']; ?></p>
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%"
                        ...
                        $staff_query = "SELECT * FROM emp_history NATURAL JOIN shift WHERE emp_id = '$staff_id' ORDER BY created_at DESC";
