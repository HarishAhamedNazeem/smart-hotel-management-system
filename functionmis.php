...
if (isset($_POST['submit'])) {
    ...
    $staff_id = $_POST['emp_id']; // Note: form parameter name is 'emp_id', but column is now 'staff_id'
    ...
    $query="UPDATE staff
SET staff_name='$first_name $last_name', staff_type_id='$staff_type_id', shift_id='$shift_id', id_card_type=$id_card_type,
