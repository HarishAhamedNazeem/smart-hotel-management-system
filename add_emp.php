            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" id="addEmployee" data-toggle="validator">
                        ...
                        <button type="submit" class="btn btn-lg btn-primary" style="border-radius: 4px; font-weight: 500; padding: 10px 24px; margin-right: 10px;">
                            <em class="fa fa-check"></em> Submit
                        </button>
                        <button type="reset" class="btn btn-lg btn-secondary" style="border-radius: 4px; font-weight: 500; padding: 10px 24px;">
                            <em class="fa fa-undo"></em> Reset
                        </button>
                    </form>
                </div>
            </div>
