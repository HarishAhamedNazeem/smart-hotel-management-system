...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <div class="profile-sidebar">
        ...
        <div class="profile-usertitle">
            <div class="profile-usertitle-name" style="color: white;">Housekeeping Manager</div>
            <div class="profile-usertitle-status">
                <span class="indicator label-warning"></span>Housekeeping Manager
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <ul class="nav menu">
        ...
        <?php if (hasPermission('service.read') || hasPermission('service.assign')): ?>
        ...
        <li class="<?php echo (isset($_GET['room_mang']) ? 'active' : ''); ?>">
            <a href="<?php echo $linkBase; ?>index.php?room_mang">
                <em class="fa fa-bed">&nbsp;</em> Room Status
            </a>
        </li>
        <?php endif; ?>
        
        <?php if (hasPermission('staff.read') || hasPermission('staff.manage_schedules')): ?>
        <li class="<?php echo (isset($_GET['staff_mang']) ? 'active' : ''); ?>">
            <a href="<?php echo $linkBase; ?>index.php?staff_mang">
                <em class="fa fa-users">&nbsp;</em> Staff Schedules
            </a>
        </li>
        <?php endif; ?>
        
        <?php if (hasPermission('booking.read')): ?>
